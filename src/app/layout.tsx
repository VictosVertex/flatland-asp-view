...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`base-scrollbar select-none min-h-screen bg-gradient-to-b from-gray-900 via-blue-950 via-[2000px] to-gray-900 to-[2400px] font-poppins text-white`}
      >
        <AppHeader />
